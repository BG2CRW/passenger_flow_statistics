...
QT_MOC_LITERAL(2, 26, 0)
    ...
    "SocketThread\0UpdateSignal\0\0"
};
...
static const uint qt_meta_data_SocketThread[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QImage, QMetaType::Int, QMetaType::Int,    2,    2,    2,
...
void SocketThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->UpdateSignal((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (SocketThread::*_t)(QImage , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketThread::UpdateSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SocketThread::UpdateSignal(QImage _t1, int _t2, int _t3)
{
