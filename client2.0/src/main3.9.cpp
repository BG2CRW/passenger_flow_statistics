    ...
    #define getPicture 0  ///1为提取图片，0为不需要.只能在config模式下取图片
...
///++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  ///             cout<<"queue's size is :"<<q1.size()<<endl;
                    ...
                    for(int i=0;i<nums;i++)
                    {
                        ...
                        else
                        {
                            if(currentFrame%3==1) ///三帧取一针
                            {
                                ...
                                ssr<<xuhao;
                                xuhao++;
                                sr="getPictures/"+filename+ssr.str()+".jpg";
                                //cout<<ssr.str()<<endl;
    ...
    {
        #if getPicture
        cout<<"input the filename of pictures:"<<endl;
        cin>>filename;
        #endif // getPicture
      // 初始化
      NET_DVR_Init();
...
///*************************************************************
      ...
      #if !configdebug
      char *connectip=argv[5];char *connectduankou=argv[6];
...
#if vediodebug ///跑监控
{
      ...
      while(1)
      {
            ...
            socketMat.get(order,(int&)thre,hour,minute,xtest,dxtest,IP1,admin1,code1,port);
